...
public class RefreshListView extends ListView implements OnScrollListener {
    ...
    private TextView tv_pull_to_refresh_title;
    ...
    private void initHeaderView() {
        ...
        tv_pull_to_refresh_title = (TextView) mHeaderView.findViewById(R.id.tv_pull_to_refresh_title);
        tvTime = (TextView) mHeaderView.findViewById(R.id.tv_des);
        ivArrow = (ImageView) mHeaderView.findViewById(R.id.iv_arrow);
        pbProgress = (ProgressBar) mHeaderView.findViewById(R.id.pb_list);
    ...
    private void initFooterView() {
        mFooterView = View.inflate(getContext(),
                R.layout.layout_footer_list, null);
    ...
    private void refreshState() {
        switch (mCurrentState) {
            case STATE_PULL_TO_REFRESH:
                tv_pull_to_refresh_title.setText("下拉刷新");
                pbProgress.setVisibility(View.INVISIBLE);
                ivArrow.setVisibility(View.VISIBLE);
                ivArrow.startAnimation(animDown);
                break;
            case STATE_RELEASE_TO_REFRESH:
                tv_pull_to_refresh_title.setText("松开刷新");
                pbProgress.setVisibility(View.INVISIBLE);
                ivArrow.setVisibility(View.VISIBLE);
                ivArrow.startAnimation(animUp);
                break;
            case STATE_REFRESHING:
                tv_pull_to_refresh_title.setText("正在刷新...");
