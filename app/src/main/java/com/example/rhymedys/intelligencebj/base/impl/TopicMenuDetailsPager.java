...
public class TopicMenuDetailsPager extends BaseMenuDetailsPager {


    public TopicMenuDetailsPager(Activity activity, NewsMenuBean.NewsMenuData data) {
        super(activity);
    }
    ...
    public View initView() {
        ...
        textView.setText("TopicMenuDetailsPager");
